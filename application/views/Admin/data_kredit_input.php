          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="<?php echo base_url().'index.php/Admin/Admin/data_kredit_input_aksi' ?>" method="POST">
                    <div class="row">
                    <div class="col-md-5" class="form-group">
                        <label> Data Customer Ini Diambil Dari Data Customer Langsung</label>
                        <select name="nm_kredit" class="form-control">
                        ...
                        <select name="nm_motor" class="form-control">
                          <option disable="">Silahkan Memilih Data Dibawah Ini</option>
                        ...
                        <select name="hg_motor" class="form-control">
                          <option disable="">Silahkan Memilih Data Dibawah Ini</option>
                          <?php foreach ($tbl_motor as $motor) : ?>
                        ...
                        <select name="lm_angsuran" class="form-control">
                          <option disable="">Silahkan Memilih Data Dibawah Ini</option>
                          <option>2</option>
                          <option>4</option>
                          <option>6</option>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="dp_awal" >
                        </div>
                      </div>
                    </div>
